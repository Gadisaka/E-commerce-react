...
const Services = () => {
  return (
    <div className='relative h-full text-black'>
        <div className=''>
            <div className='absolute w-full h-full bg-[#DFDFDF] z-[-10]'></div>
            <img 
            src={CTA} 
            className='w-full h-[833PX] bg-center bg-cover'
            alt="" />
        </div>
        <div className='absolute ml-10 top-28 text-[#12273D]'>
            <div className='pl-[700px] '>
                <h1 className='font-lora font-bold text-9xl text-[#EBEBEB]'>SERVICES</h1>
                <h2 className='relative left-[180px] bottom-16 font-lora font-bold text-5xl'>Services</h2>
            </div>
        <div className='relative gap-28 left-40 flex  justify-around text-center font-Nunito-sans font-bold top-[80px]'>
            <div className='w-[339px] h-[234px] text-xl'>
                <svg className="relative left-[100px]" width="104" height="104" viewBox="0 0 104 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M60.546 89.1428H89.5153V96.5714H60.546V89.1428Z" fill="#12273D"></path>
                <path d="M60.546 74.2858H104V81.7143H60.546V74.2858Z" fill="#12273D"></path>
                <path d="M60.546 59.4286H104V66.8572H60.546V59.4286Z" fill="#12273D"></path>
                <path d="M69.7762 34.2346L53.3035 0L36.8308 34.2346L0 39.7243L26.6518 66.3743L20.3582 104L46.0612 90.142V81.7477L29.9796 90.4206L33.7891 67.6297L34.4336 63.778L31.7069 61.0554L15.5638 44.9094L37.8737 41.5851L41.6397 41.0243L43.3272 37.5217L53.3035 16.7849L63.2798 37.5217L64.9673 41.0243L68.7333 41.5851L95.7254 45.6151L96.7574 38.2571L69.7762 34.2346Z" fill="#12273D"></path>
                </svg>
                <h1 className='text-4xl align-middle py-14'>Car sales</h1>
                <p>
            ...
            <div className='relative w-[339px] mx-[150px] h-[234px] text-xl'>
                ...
                <h1 className='text-4xl align-middle py-14'>Car rental</h1>
                <p>
            ...
            <div className=' w-[339px]  h-[434px] text-xl'>
                <svg className="relative left-[100px]" width="104" height="97" viewBox="0 0 104 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M83.9286 0C80.6194 0 23.7252 0 20.0773 0L0 27.378L52.2157 96.1977L104 27.3701L83.9286 0ZM28.5454 30.3858L43.2566 74.336L9.91022 30.3858H28.5454ZM34.9542 30.3858H69.0697L52.129 81.6966L34.9542 30.3858ZM75.4698 30.3858H94.1262L60.8812 74.5722L75.4698 30.3858ZM80.8487 6.07716L94.2184 24.3086H75.4738L69.4917 6.07716H80.8487ZM63.0957 6.07716L69.0778 24.3086H34.9278L40.91 6.07716H63.0957ZM23.1568 6.07716H34.5138L28.5316 24.3086H9.78706L23.1568 6.07716Z" fill="#12273D"></path>
                </svg>
